 ...
 **/
public class Activator_correct_ServiceTracker implements BundleActivator {
  ...
  class LogServiceDecorator implements ServiceTrackerCustomizer {
    ...
    public Object addingService(final ServiceReference reference) {
     System.out.println("Logservice added");
  ...
  class LogServiceTest implements Runnable {
    public void run() {
      ...
      while (Thread.currentThread() == m_logTestThread) {
    	...
    	ServiceReference sr = m_logTracker.getServiceReference();
    	String[] props =  sr.getPropertyKeys();
    	String oc = (String)sr.getProperty("objectClass");
